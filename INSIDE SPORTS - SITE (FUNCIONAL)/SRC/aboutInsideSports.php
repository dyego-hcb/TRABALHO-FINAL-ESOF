...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Quem Somos</title>
    </head>
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom shadow-sm mb-3">
                ...
                <main class="flex-fill">
                    <div class="container">
                        ...
                        <hr>
                        <p>
                            Inside Sports e uma loja virutal (e-comerce) ficticia criada em 2022 pelos alunos Dyego Henrique e Helen Ayumi,
                            essa loja foi criada para o trabalho final da disciplina de Programaco para Internet II, ministrada pelo 
                            professor Silvio.
                        </p>
                        <p>
                            Nossa loja e voltada apenas ao ramo de roupas esportivas, onde voce ira encontrar roupas para academia,
                            camisetas de times, chuteiras, tenis, etc;
                            <br>
                            Tudo relacionado a vestimentas esportivas.
                        </p>
                        <br>
                        <p>
                            <img src="../img/INSIDE_SPORTS_LOGO_COMPLETA_VETORIZADA.png" alt="Logo InsideSports" class="imgLogoQuemSomos">
                        </p>
                    </div>
                </main>
