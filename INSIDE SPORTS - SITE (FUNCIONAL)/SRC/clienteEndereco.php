                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-8">
                                ...
                                <div class="form-floating mt-3 mb-3">
                                    <a class="btn btn-lg btn-Amarelo" href="clienteCadNovoEndereco.php">Cadastrar Endereco</a>
                                    <a class="btn btn-lg btn-outline-danger" href="editarEndereco.php">Alterar Endereco</a>
                                </div>
