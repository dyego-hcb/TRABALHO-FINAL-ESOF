...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Dados do Cliente Contato</title>
    </head>
    <body>
                        ...
                        <div class="row gx-3">
                            <div class="col-4">
                                <div class="list-group mb-3">
                                    ...
                                    <a href="clienteContato.php" class="list-group-item list-group-item-action bg-Amarelo text-light">
                            ...
                            <div class="col-8">
                                <div class="container">
                                    <?php
                                        echo "<h3 class>Dados de Contato de $logado</h3>";
                                    ?>
                                </div>
                                <?php
                                ...
                                <div class="form-floating mt-3 mb-3">
                                    <a class="btn btn-lg btn-Amarelo" href="editarDadosContatoCliente.php">Editar Dados</a>
                                </div>
                            </div>
                        </div>
                    </div>
