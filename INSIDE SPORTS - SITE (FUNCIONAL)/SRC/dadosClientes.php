...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Dados do Cliente</title>
    </head>
    <body>
                        ...
                        <div class="row gx-3">
                            <div class="col-4">
                                <div class="list-group">
                                    ...
                                    <a href="dadosClientes.php" class="list-group-item list-group-item-action bg-Amarelo text-light">
                            ...
                            <div class="col-8">
                                <div class="container">
                                    <h3 class>Meus Dados Pessoais</h3>
                                </div>
                                <?php
                                    $sql = "SELECT * FROM usuarios WHERE email = '$_SESSION[fieldEmail]'";
                                    $result = $conexao->query($sql);
                                    $user_data = mysqli_fetch_assoc($result);
                                    echo "<p>Nome: ".$user_data['nome']."</p>";
                                    echo "<p>Senha: ****</p>";
                                    echo "<p>Email: ".$user_data['email']."</p>";
                                    echo "<p>Telefone: ".$user_data['telefone']."</p>";
                                    echo "<p>CPF: ".$user_data['cpf']."</p>";
                                    echo "<p>Data de Nacimento: ".$user_data['data_nascimento']."</p>";
                                ?>
                                <div class="form-floating mt-3 mb-3">
                                    <a class="btn btn-lg btn-Amarelo" href="editarDadosCliente.php">Editar Dados</a>
                                </div>
                            </div>
                        </div>
                    </div>
