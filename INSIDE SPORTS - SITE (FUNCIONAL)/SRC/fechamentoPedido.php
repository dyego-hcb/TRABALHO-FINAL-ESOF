...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Fechamento da Compra</title>
    </head>
    <body>
                ...
                <main class="flex-fill">
                    <div class="container text-center">
                        ...
                        <p>
                            Atenciosamente,
                            <br>
                            Equipe Inside Sports
                        </p>
                        <p>
                            <a href="home.php" class="btn btn-Amarelo btn-lg">Voltar à Página Principal</a>
                        </p>
                    </div>
                </main>
