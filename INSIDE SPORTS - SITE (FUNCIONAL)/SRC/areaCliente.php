...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Area do Cliente</title>
    </head>
    <body>
                        ...
                        <div class="row gx-3">
                            <div class="col-4">
                                <div class="list-group">
                                    <a href="areaCliente.php" class="list-group-item list-group-item-action bg-Amarelo text-light">
                            ...
                            <div class="col-8">
                                <div class="container">
                                    <?php
                                        echo "<h1>Bem vindo <b>$logado</b></h1>";
                                    ?>
                                    <p>Escolha por onde navegar no menu ao lado.</p>
                                    <br>
                                    <img src="../img/INSIDE_SPORTS_LOGO_COMPLETA_VETORIZADA.png" height="300px">
                                </div>
                            </div>
                        </div>
                    </div>
