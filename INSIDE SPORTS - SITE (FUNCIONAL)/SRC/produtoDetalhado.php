...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Detalhes do Produto</title>
    </head>
    <body>
                    ...
                    <div class="container">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                <img src="../img/IMAGENS INSIDE/Chuteira masculina/Chuteira masculina 4.jpg" class="img-thumbnail" id="imgProdutoDestacada">
                                <br class="clearfix">
                                <div class="row my-3 gx-3">
                                    <div class="col-3">
                                        <img src="../img/IMAGENS INSIDE/Chuteira masculina/Chuteira masculina 4.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                    </div>
                                    <div class="col-3">
                                        <img src="../img/IMAGENS INSIDE/Chuteira masculina/Chuteira masculina 3.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                    </div>
                                    <div class="col-3">
                                        <img src="../img/IMAGENS INSIDE/Chuteira masculina/Chuteira masculina 2.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                    </div>
                                    <div class="col-3">
                                        <img src="../img/IMAGENS INSIDE/Chuteira masculina/Chuteira masculina 1.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <h1>Chuteira Nike Tiempo</h1>
                                <p>Chuteira nike tiempo, otima chuteira, usada por varios jogadores profissionais</p>
                                <p>Essa chuteira e de travas, voltada para o futebol de campo, com travas emborrachadas, fazendo com que voce tenha mais aderencia no campo molhado e possa mostra o melhor do seu futebol.</p>
                                <p>
                                    <button class="btn btn-lg btn-Amarelo mb-3 mb-xl-0 me-2">
                                        <i class="bi-cart"></i>
                                        Adicionar ao Carrinho
                                    </button>
                                    <button class="btn btn-lg btn-outline-amarelo">
                                        <i class="bi-heart"></i>
