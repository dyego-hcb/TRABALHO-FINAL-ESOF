...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Contato</title>
    </head>
    <body>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <form class="col-sm-10 col-md-8 col-lg-6">
                                ...
                                <button type="button" class="btn btn-lg btn-Amarelo" onclick="window.location.href='confirmContact.php'">Enviar Mensagem</button>
                                <p class="mt-3">
