...
<html lang="pt-br">
    <head>
        ...
        <title>Inside Sports : Produtos Favoritos</title>
    </head>
    <body>
                    ...
                    <div class="container">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="list-group mb-3">
                                    ...
                                    <a href="clienteFavoritos.php" class="list-group-item list-group-item-action bg-Amarelo text-light">
                            ...
                            <div class="col-8">
                                <div class="container">
                                    <h3 class>Produtos Favoritos</h3>
                                </div>
                                <div class="row g-3">
                                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                        <div class="card text-center bg-light">
                                            <a href="#" class="position-absolute end-0 p-2 text-Amarelo" title="Remove dos favoritos">
                                                <i class="bi-x" style="font-size: 24px; line-height: 24px;"></i>
                                            </a>
                                            <img src="../img/IMAGENS INSIDE/Tenis academia masculino/Tenis academia masculino 2.jpg" class="card-img-top" alt="...">
                                            <div class="card-header">
                                                R$ 189,50
                                            </div>
                                            <div class="card-body">
                                                <h5 class="card-title">Tenis Addidas Masculino</h5>
                                                <p class="card-text truncar-3l">Tenis addias fit, otimo para academia, caminhadas, basquete, otimo para o seu dia a dia.</p>
                                            </div>
