            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom shadow-sm mb-3">
                ...
                <main class="flex-fill">
                    <div class="container">
                        ...
                        <p>A sua privacidade é importante para nós. É política do Inside Sports respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site
                            <a href="home.php">Inside Sports</a>, e outros sites que possuímos e operamos.
                        </p>
                        ...
                        <h2>Política de Cookies Inside Sports</h2>
                    ...
                    é recomendável que você não desative os cookies.
                        ...
                        <ul>
                            <li> Cookies relacionados à conta
                                <br>
                                <br>
                                Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair do sistema, porém, em alguns casos, eles poderão permanecer
                        ...
                        <ul>
                            ...
                            <li>
                                Periodicamente, testamos novos recursos e fazemos alterações subtis na maneira como o site se apresenta. Quando ainda estamos testando novos recursos, esses cookies podem ser usados ​​para garantir que você receba uma experiência consistente enquanto estiver no site, enquanto
                        ...
                        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Inside Sports oferece no site e com caráter enunciativo, mas não limitativo:</p>
                        <ul>
                            <li>
                                A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;
                            </li>
                            <li>B) Não divulgar conteúdo ou propaganda de natureza racista, xenofóbica,
                            ...
                            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Inside Sports, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                        </ul>
